...
namespace PC_REST_API.Repositories.Classes
{
    ...
    public class CharacteristicRepository : ICharacteristicRepository
    {
        ...
        public CharacteristicRepository(CharacteristicContext characteristicContext)
        {
            _characteristicContext = characteristicContext;
        }
        ...
        {
            return await _characteristicContext.Characteristics.FindAsync(characteristicId);
        }
